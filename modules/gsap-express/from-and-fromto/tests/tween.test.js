...
describe("from", () => {
    it('first-fromto', async () => {
        ...
        expect(tween.vars.startAt).not.toBeUndefined()

        expect(tween.vars.x).not.toBe(tween.vars.startAt.x)
        expect(tween.vars.y).not.toBe(tween.vars.startAt.y)
